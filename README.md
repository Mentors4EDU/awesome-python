...
15. [Rich](https://pypi.org/project/rich/)
16. [PyPy](https://www.pypy.org/)
17. [taichi](https://github.com/taichi-dev/taichi)
18. [SciPy](https://scipy.org/)
19. [pandas](https://pypi.org/project/pandas/)
20. [ipython](https://pypi.org/project/ipython/)
21. [Numba](https://numba.pydata.org/)
22. [scikit-learn](https://scikit-learn.org/stable/)
23. [jupyXplorer](https://pypi.org/project/jupyXplorer/)
24. [conda-deps](https://pypi.org/project/conda-deps/)
25. [cosine-crypto](https://cosine-documentation.readthedocs.io/en/latest/)
26. [atlassian-python-api](https://github.com/atlassian-api/atlassian-python-api)

### 📐 Engineering
27. [silas](https://pypi.org/project/silas/)
28. [upy2](https://pypi.org/project/upy2/)
29. [thermo](https://pypi.org/project/thermo/)
30. [algebra](https://pypi.org/project/algebra/)
31. [GNU Radio](https://github.com/gnuradio/gnuradio)
32. [statsmodels](https://pypi.org/project/statsmodels/) 
33. [simple-linear-algebra](https://pypi.org/project/simple-linear-algebra/)
